...
- **Aşama 4b (sıradaki):** AutomationStatus'tan `ManualSyncButtons` ("Ticimax Stok Senkronla") kaldır **+** `ticimax_stock_sync` router'ını birlikte devre dışı bırak (frontend+backend aynı paket, boot testli).
