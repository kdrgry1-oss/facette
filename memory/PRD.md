...
```
https://erp-sync-core.preview.emergentagent.com/api/orders/cargo/mng-webhook
```
...
- MNG'ye webhook URL bildirimi: `https://erp-sync-core.preview.emergentagent.com/api/orders/cargo/mng-webhook`
