...
```
https://facette-erp-1.preview.emergentagent.com/api/orders/cargo/mng-webhook
```
...
- MNG'ye webhook URL bildirimi: `https://facette-erp-1.preview.emergentagent.com/api/orders/cargo/mng-webhook`
