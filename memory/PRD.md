...
```
https://facette-ticimax-sync.preview.emergentagent.com/api/orders/cargo/mng-webhook
```
...
- MNG'ye webhook URL bildirimi: `https://facette-ticimax-sync.preview.emergentagent.com/api/orders/cargo/mng-webhook`
