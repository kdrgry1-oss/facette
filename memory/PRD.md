...
```
https://pagespeed-fix-3.preview.emergentagent.com/api/orders/cargo/mng-webhook
```
...
- MNG'ye webhook URL bildirimi: `https://pagespeed-fix-3.preview.emergentagent.com/api/orders/cargo/mng-webhook`
