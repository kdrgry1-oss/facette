...
```
https://facette-admin-2.preview.emergentagent.com/api/orders/cargo/mng-webhook
```
...
- MNG'ye webhook URL bildirimi: `https://facette-admin-2.preview.emergentagent.com/api/orders/cargo/mng-webhook`
