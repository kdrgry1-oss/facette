...
```
https://ecommerce-erp-2.preview.emergentagent.com/api/orders/cargo/mng-webhook
```
...
- MNG'ye webhook URL bildirimi: `https://ecommerce-erp-2.preview.emergentagent.com/api/orders/cargo/mng-webhook`
